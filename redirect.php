		...
		<div class="container2">
			...
			<div class="row">
				<div class="col s12 m4">
					<div class="card">
						<img class="activator" src="images/5.jpg" style="width: 100%; height: 100%;"></img>
						<div class="card-content">
							<span class="card-title activator grey-text text-darken-4">Motor Zundung<i class="fa fa-caret-up" style="float: right;"></i><br></span>
							<p style="font-size: 1.15rem; line-height: 1.3rem;">Encompassing a huge array of interesting events MZ has surpassed......</p>
						</div>
						<div class="card-reveal">
							<span class="card-title grey-text text-darken-4"><b>Motor Zundung</b><i class="fa fa-times" style="float: right;"></i></span>
							<div class="text">
								Encompassing a huge array of interesting events MZ has surpassed every insurmountale feat. From thrilling bike stunts in the student's backyard to mind boggling robotic events MZ hasn't left any aspect of automotive passion untouched. It's a race where ignited minds of India get ready to hit the nitrous. With the intensity rising up, the challenge is about to get tougher, before breaking speed limits, make sure you have seatbelts on.
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col s12 m6 l3">
						<div class="team-index">
							<img class="activator" src="images/team/sae/arvind.jpg">
							<h5>Arvind Satya</h5>
							<h6><i>President</i></h6>
					...
					<div class="col s12 m6 l3">
						<div class="team-index">
							<img class="activator" src="images/team/sae/shubham.jpg">
							<h5>Shubham Singh</h5>
					...
					<div class="col s12 m6 l3">
						<div class="team-index">
							<img class="activator" src="images/team/sae/ananya.jpg">
							<h5>Ananya Roy</h5>
							<h6><i>Convenor</i></h6>
							<a href="#"><i class="fa fa-facebook fa-lg"></i></a>
							<a href="#"><i class="fa fa-phone fa-lg"></i></a>
					...
					<div class="col s12 m6 l3">
						<div class="team-index">
							<img class="activator" src="images/team/sae/vikram.jpg">
							<h5>Vikram Reddy</h5>
							<h6><i>Treasurer</i></h6>
							<a href="#"><i class="fa fa-facebook fa-lg"></i></a>
							<a href="#"><i class="fa fa-phone fa-lg"></i></a>
